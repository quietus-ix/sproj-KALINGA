...
<div class="w-full h-full bg-primaryfd p-4 overflow-y-auto">
     
     <!-- statistics container -->
          <div class="w-full h-3/5 flex flex-row-reverse gap-4">
               <!-- statistics and summary card -->
               <div class="w-3/4 h-full flex flex-col bg-primary shadow-lg rounded-lg overflow-hidden">
                    <!-- chart section -->
                    <div id="stats_container" class="w-full h-3/4 p-3 relative z-0">
                    ...
                    <!-- counters section -->
                    <div class="w-full h-1/4 bg-gray-200 flex relative z-10">
                         <!-- counter: total # of donation items -->
                         <div class="w-1/3 h-full flex flex-col gap-3 p-4 cursor-pointer bg-primary group/card1">
                         ...
                         <div class="w-1/3 h-full flex flex-col gap-3 p-4 cursor-pointer hover:bg-gray-300 group/card2">
                              <div class="flex items-center">
                         ...
                         <div class="w-1/3 h-full flex flex-col gap-3 p-4 cursor-pointer hover:bg-gray-300 group/card3">
                              <div class="flex items-center">
               ...
               <!-- welcome card -->
               <div class="w-1/4 h-full flex flex-col items-center bg-primary shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="w-full h-1/6 flex flex-col items-center">
                         <h1 class="text-3xl font-[Questrial] font-bold">Welcome</h1>
     ...
     <!-- summary container -->
          <div class="w-full h-max flex flex-col p-4 bg-primary rounded-lg shadow-lg mt-4">
