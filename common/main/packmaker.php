...
<div class="flex w-full h-full relative z-0">
	...
	<div class="main-controls flex flex-col h-full w-[13%] border-e-2 border-gray-300 p-3">
				...
				<!-- add item modal -->
					<dialog id="addItem_modal" class="modal">
						<div id="addItem_modal_container" class="modal-box rounded-md bg-primary">
							...
							<form id="addItem_form" class="form-control w-full max-w-xs mt-5 gap-5">							            
		...
		<div id="pack_tab" class="w-full flex items-center bg-secondary rounded-lg py-2 px-3 cursor-pointer my-1">
			...
			<a href="#" class="capitalize text-base text-primary tabflex">packages</a>
		</div>
	</div>
