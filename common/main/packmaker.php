...
<div class="tw-flex tw-w-full tw-h-full tw-relative tw-z-0">
	...
	<div class="main-controls tw-flex tw-flex-col tw-h-full tw-w-[13%] tw-border-e-2 tw-border-gray-300 tw-p-3">
		...
		<div id="pack_tab" class="tw-w-full tw-flex tw-items-center tw-bg-secondary tw-rounded-lg tw-py-2 tw-px-3 tw-cursor-pointer tw-my-1">
			...
			<a href="#" class="tw-capitalize tw-text-base tw-text-primary tabflex">packages</a>
		</div>
	</div>
