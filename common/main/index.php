          ...
          <header class="flex h-[10%] items-center border-b border-primaryfd entranceHeader relative z-10">
               ...
               <div class="w-[24%] h-full flex gap-5 justify-end items-center text-lg pe-8">
                    <div x-data="{ isOpen: false }" class="relative inline-block">
                         ...
                         <button @click="isOpen = !isOpen" class="relative z-10 block p-2 text-gray-700 bg-primary border border-transparent rounded-md focus:border-secondary focus:ring-opacity-40 focus:ring-secondary focus:ring focus:outline-none">
                              <svg class="w-6 h-6 text-quatenary" viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <div x-show="isOpen" 
                              ...
                              class="absolute right-0 z-20 w-64 mt-2 overflow-hidden origin-top-right bg-primary rounded-md shadow-lg">
                              <div class="py-2">
                                   <?php
                                   ...
                                   ?>
                                   <a href="#" class="flex items-center px-4 py-3 mx-2 transition-colors duration-300 transform border-b border-gray-100 hover:bg-gray-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 me-3">
                                             <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                                        </svg>

                                        <p class="mx-2 text-sm text-tertiary"><span class="font-bold" href="#">Place holder user</span> placeholder action <span class="text-secondary hover:underline" href="#">placeholder targer</span></p>
                                   </a>
                                   <?php } ?>
                              </div>
                         </div>
