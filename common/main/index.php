          ...
          <section class="tw-flex tw-h-[90%]">
               <nav class="tw-flex tw-flex-col tw-justify-between tw-h-full tw-w-[6%] tw-border-e tw-border-primaryfd entranceNav">
                    <div class="tw-flex tw-flex-col tw-w-full tw-items-center">
                         ...
                         <div id="nav_makePackage" class="tw-w-full tw-flex tw-relative tw-py-4 tw-cursor-pointer hover:tw-bg-primaryfd tw-gap-3">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 640 512" class="tw-w-7 tw-h-7 tw-ms-7">
                              ...
                              <a class="nav-label tw-absolute tw-left-[30%] tw-hidden tw-text-xl">Pack Maker</a>
                         </div>
                    </div>
