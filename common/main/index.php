...
<head>
     ...
     <script src="../../src/extensions/cdn.js" defer></script> <!-- alphine js -->
     ...
     <script src="../../src/extensions/vfs_fonts.js"></script>
     <script src="../../src/extensions/datatables/Buttons-2.4.2/js/buttons.html5.min.js"></script>
     <script src="../../src/extensions/datatables/Buttons-2.4.2/js/buttons.print.min.js"></script>
     <script src="../../src/extensions/datatables/Buttons-2.4.2/js/buttons.colVis.min.js"></script>

</head>

<body class="">
     <div class="w-svw h-svh flex flex-col bg-primary overflow-hidden">
          <header class="flex h-[10%] items-center border-b border-primaryfd entranceHeader relative z-10">
               ...
               <div class="w-[24%] h-full flex gap-5 justify-end items-center text-lg pe-8">
                    <div x-data="{ isOpen: false }" class="relative inline-block ">
                         ...
                         <div x-show="isOpen" @click.away="isOpen = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" class="absolute right-0 z-20 w-56 pt-2 mt-2 overflow-hidden origin-top-right bg-primary rounded-md shadow-xl">
                              ...
                              <a href="#" class="flex items-center p-3 mt-2 text-sm transition-colors duration-300 transform hover:bg-gray-100 cursor-default">
                                   ...
                                   <div class="mx-1">
                                        <h1 class="text-sm font-semibold text-quatenary capitalize">
                                             <?php echo $sel['usr_fname'] . ' ' . $sel['usr_lname']; ?></h1>
          ...
          <section class="flex flex-col md:flex-row h-[90%]">
               <nav class="hidden md:flex flex-col justify-between h-full w-[6%] border-e border-primaryfd entranceNav">
                    <div class="tabs flex flex-col w-full items-center">
                         ...
                         <div id="nav_bundleMaker" class="w-full flex relative py-4 cursor-pointer hover:bg-primaryfd gap-3">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512" class="w-7 h-7 ms-7">
                              ...
                              <a class="nav-label absolute left-[30%] hidden text-xl">Bundle Maker</a>
                         </div>
                    </div>
               ...
               <nav class="w-full h-[10%] static z-30 px-3 py-1 flex md:hidden justify-center gap-3 bg-primary border-t-2">
                    <div id="nav_inventory_m" class="w-max flex relative py-4 hover:bg-primaryfd tooltip" data-tip="Inventory">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512" class="w-5 h-5">
                              <path d="M248 0H208c-26.5 0-48 21.5-48 48V160c0 35.3 28.7 64 64 64H352c35.3 0 64-28.7 64-64V48c0-26.5-21.5-48-48-48H328V80c0 8.8-7.2 16-16 16H264c-8.8 0-16-7.2-16-16V0zM64 256c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H224c35.3 0 64-28.7 64-64V320c0-35.3-28.7-64-64-64H184v80c0 8.8-7.2 16-16 16H120c-8.8 0-16-7.2-16-16V256H64zM352 512H512c35.3 0 64-28.7 64-64V320c0-35.3-28.7-64-64-64H472v80c0 8.8-7.2 16-16 16H408c-8.8 0-16-7.2-16-16V256H352c-15 0-28.8 5.1-39.7 13.8c4.9 10.4 7.7 22 7.7 34.2V464c0 12.2-2.8 23.8-7.7 34.2C323.2 506.9 337 512 352 512z" />
                         </svg>
                    </div>

                    <div id="nav_bundleMaker_m" class="w-max flex relative py-4 hover:bg-primaryfd tooltip active-nav-m" data-tip="Bundle Maker">
                         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="w-5 h-5">
                              <path d="M50.7 58.5L0 160H208V32H93.7C75.5 32 58.9 42.3 50.7 58.5zM240 160H448L397.3 58.5C389.1 42.3 372.5 32 354.3 32H240V160zm208 32H0V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192z" />
                         </svg>
                    </div>

                    <div id="nav_dashboard_m" class="w-max flex relative py-4 hover:bg-primaryfd tooltip active-nav-m" data-tip="Dashboard">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                              <path stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                         </svg>
                    </div>

                    <div id="nav_settings_m" class="w-max flex relative py-4 tooltip hover:bg-primaryfd" data-tip="Settings">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" class="w-5 h-5">
                              <path d="M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z" />
                         </svg>
                    </div>

                    <div id="nav_faq_m" class="w-max flex relative py-4 tooltip hover:bg-primaryfd" data-tip="FAQ">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" class="w-5 h-5">
                              <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM169.8 165.3c7.9-22.3 29.1-37.3 52.8-37.3h58.3c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24V250.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1H222.6c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z" />
                         </svg>
                    </div>
