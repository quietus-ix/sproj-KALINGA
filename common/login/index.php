...
<body class="bg-primary overflow-hidden w-screen h-screen relative">

   <div class="fixed top-0 left-0 w-screen h-20 p-3 z-10 entranceAlt">
      <img src="../../src/assets/img/logo_01.svg" class="logo-flair w-16 absolute left-[3%]" alt="">
   </div>

   <div class="c1 w-1/2 h-full absolute left-0 flex flex-col justify-center items-center px-10">

      <div class="si-header flex flex-col items-center mb-3 entranceAlt">
         <h1 class="text-secondary text-5xl font-[Questrial]">sign in</h1>
         <h4 class="text-tertiary text-base font-semibold font-[Source Sans]">Aiding those in need is now just one click away</h4>
      </div>

      <form method="post" id="signin" class="flex flex-col w-3/5 h-max entranceAlt">
         ...
         <div class="border-b-2 border-tertiary w-full flex flex-col-reverse mb-4">
            ...
            <div class="flex w-full justify-center items-center px-2">
               ...
               <input type="text" id="SI_username" placeholder="username" class="bg-primary text-quatenary placeholder:text-tertiary focus:outline-none w-full px-2 py-1" autocomplete="off" />
            </div>
         ...
         <div class="border-b-2 border-tertiary w-full flex flex-col-reverse mb-4">
            ...
            <div class="flex w-full justify-center items-center px-2">
               ...
               <input type="password" id="SI_password" placeholder="password" class="bg-primary text-quatenary placeholder:text-tertiary focus:outline-none w-full px-2 py-1" />
            </div>
   ...
   <div class="c2 w-full h-full absolute right-[-50%] flex entrance">
      <div class="p-2 h-full w-1/2 flex justify-center items-center">
         <div class="main-card flex justify-center flex-col w-full h-full shadow-2xl rounded-lg overflow-hidden relative">
            <div class="card-bg bg-[url('../../src/assets/img/bg-login.svg')] bg-cover h-full w-[300%] bg-no-repeat absolute z-[1] top-0 left-0">
            </div>
            ...
            <div class="flex w-full justify-center align-center my-3 z-[2]">
               <button id="switch" class="bg-quatenary text-primary px-4 py-2 rounded text-lg hover:bg-tertiary uppercase" disabled>sign up</button>
            </div>
         </div>
      </div>

      <div class="flex flex-col justify-center items-center w-1/2 h-screen px-10 gap-5">
         ...
         <form action="" id="signup" method="post" class="flex flex-col w-3/5 h-max opacity-0">
            ...
            <div class="flex gap-5 mb-3">
               <div class="border-b-2 border-quatenary w-full flex flex-col-reverse ">
                  <div class="flex w-full justify-center items-center px-2">
                     ...
                     <input type="text" id="SU_fname" placeholder="first name" class="focus:outline-none bg-primary w-full px-2 py-1 text-quatenary placeholder:text-tertiary" autocomplete="off" />
                  </div>
               ...
               <div class="border-b-2 border-quatenary w-full flex flex-col-reverse ">
                  <div class="flex w-full justify-center items-center px-2">
                     ...
                     <input type="text" id="SU_lname" placeholder="last name" class="focus:outline-none w-full px-2 py-1 bg-primary text-quatenary placeholder:text-tertiary" />
                  </div>
            ...
            <div class="border-b-2 w-full flex flex-col-reverse border-tertiary mb-3">
               <div class="flex w-full justify-center items-center px-2">
                  ...
                  <input type="text" id="SU_username" placeholder="username" class="focus:outline-none w-full px-2 py-1 bg-primary text-quatenary placeholder:text-tertiary" />
               </div>
            ...
            <div class="border-b-2 w-full flex flex-col-reverse border-tertiary mb-3">
               <div class="flex w-full justify-center items-center px-2">
                  ...
                  <input type="email" id="SU_email" placeholder="email address" class="focus:outline-none w-full px-2 py-1 bg-primary text-quatenary placeholder:text-tertiary" />
               </div>
            ...
            <div class="border-b-2 w-full flex flex-col-reverse border-tertiary mb-3">
               <div class="flex w-full justify-center items-center px-2">
                  ...
                  <input type="password" id="SU_password" placeholder="password" class="focus:outline-none w-full px-2 py-1 bg-primary text-quatenary placeholder:text-tertiary" />
               </div>
            ...
            <div class="border-b-2 border-tertiary w-full flex flex-col-reverse">
               <div class="flex w-full justify-center items-center px-2">
                  ...
                  <input type="password" id="SU_repassword" placeholder="confirm password" class="focus:outline-none w-full px-2 py-1 bg-primary text-quatenary placeholder:text-tertiary" />
               </div>
