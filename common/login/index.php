...
<body class="bg-primary overflow-hidden w-screen h-screen relative">
	...
	<div class="c1 w-full sm:w-1/2 h-full absolute left-0 flex flex-col justify-center items-center px-10 lg:px-20 z-20">
	...
	<div class="c2 w-full h-full absolute -right-full sm:right-[-50%] flex entrance">
		...
		<div class="flex flex-col justify-center items-center w-full sm:w-1/2 h-screen px-10 lg:px-20 gap-5 static z-10">
