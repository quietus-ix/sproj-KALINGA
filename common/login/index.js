...
$(document).ready(() => {
	...
	$(".switch").click(() => {
		if (!clicked) {
			...
			$(".c2-fix").removeClass("hidden").addClass("flex");
			...
			setTimeout(() => {
				...
				$(".c1").removeClass("flex").addClass("hidden");
			...
			$(".c1").removeClass("hidden").addClass("flex");
			...
			setTimeout(() => {
				...
				$(".c2-fix").removeClass("flex").addClass("hidden");
	...
	$("#SU_password").keyup(() => {
		...
		if (SU_pwHasVal.length < 4) {
			...
			$("#SU_password")
				.parent()
				.parent()
				.removeClass("border-err border-wrng");
