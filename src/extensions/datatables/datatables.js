 ...
 *   https://datatables.net/download/#dt/dt-1.13.8/b-2.4.2/sp-2.2.0/sl-1.7.0
 *
 * Included libraries:
 *   DataTables 1.13.8, Buttons 2.4.2, SearchPanes 2.2.0, Select 1.7.0
 */
...
(function (factory) {
  ...
  DataTable.ext = _ext = {
     ...
     *  @type string
     */
    build: "dt/dt-1.13.8/b-2.4.2/sp-2.2.0/sl-1.7.0",
  ...
  (function () {
    ...
    var SearchPane = /** @class */ (function () {
      ...
      SearchPane.prototype.setListeners = function () {
        ...
        this.s.dtPane
          ...
          .on("user-select.dtsp", function (e, _dt, type, cell, originalEvent) {
        ...
        for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
          ...
          if (typeof comp.value === "function") {
            ...
            for (var i = 0; i < tableValsTotal.length; i++) {
              if (
                comp.value.call(this.s.dt, tableValsTotal[i], allRows[0][i])
              ) {
                comparisonObj.total++;
              }
            }
      ...
      SearchPane.prototype._buildPane = function (
        ...
        if (this.s.colExists) {
          ...
          if (
            !this.s.dt.page.info().serverSide &&
            (!dataIn || !dataIn.searchPanes || !dataIn.searchPanes.options)
          ) {
        ...
        for (
          ...
          if (selection) {
            for (
              var _c = 0, _d = this.s.dtPane.rows().indexes().toArray();
              _c < _d.length;
              _c++
            ) {
              var row = _d[_c];
    ...
    var SearchPaneST = /** @class */ (function (_super) {
      ...
      function SearchPaneST(paneSettings, opts, index, panesContainer, panes) {
        return (
          _super.call(this, paneSettings, opts, index, panesContainer, panes) ||
          this
        );
      }
      /**
      ...
      SearchPaneST.prototype.updateRows = function () {
        if (!this.s.dt.page.info().serverSide) {
          ...
          for (
            var _i = 0,
              _a = this.s.dt.rows({ search: "applied" }).indexes().toArray();
            _i < _a.length;
            _i++
          ) {
            var index = _a[_i];
      ...
      SearchPaneCascade.prototype.updateRows = function () {
        ...
        if (
          ...
          if (!this.s.dt.page.info().serverSide) {
            ...
            for (
              var _a = 0,
                _b = this.s.dt.rows({ search: "applied" }).indexes().toArray();
              _a < _b.length;
              _a++
            ) {
              var index = _b[_a];
        ...
        for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
          ...
          if (typeof comp.value === "function") {
            ...
            for (var i = 0; i < tableValsShown.length; i++) {
              if (
                comp.value.call(this.s.dt, tableValsShown[i], shownRows[0][i])
              ) {
                comparisonObj.shown++;
              }
            }
    ...
    var SearchPanes = /** @class */ (function () {
      function SearchPanes(paneSettings, opts, fromPreInit, paneClass) {
        ...
        this.dom = {
          ...
          showAll: $$1('<button type="button"/>')
            ...
            .attr("disabled", "true")
            .html(
              table.i18n("searchPanes.showMessage", this.c.i18n.showMessage),
            ),
      ...
      SearchPanes.prototype._paneDeclare = function (
        ...
        table
          ...
          .each(function (idx) {
            _this.s.panes.push(
              new _this.s.paneClass(paneSettings, opts, idx, _this.dom.panes),
            );
          });
      ...
      SearchPanes.prototype._updateFilterCount = function () {
        ...
        this.dom.title.html(
          this.s.dt.i18n("searchPanes.title", this.c.i18n.title, filterCount),
        );
        if (
        ...
        for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
          ...
          if (pane.s.colOpts.show) {
            ...
            if (this.s.serverData.searchPanes.options[colTitle]) {
              for (
                var _b = 0,
                  _c = this.s.serverData.searchPanes.options[colTitle];
                _b < _c.length;
                _b++
              ) {
                var data = _c[_b];
