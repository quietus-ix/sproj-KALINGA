      ...
      ? ((t = require("jquery")),
        ...
        "undefined" == typeof window
          ? (module.exports = function (e, a) {
              return (
                (e = e || window), (a = a || t(e)), i(e, a), n(a, 0, e.document)
              );
            })
          : (i(window, t), (module.exports = n(t, window, window.document))))
      ...
      function f(e, a) {
        for (
          var n,
            ...
            s = function (e) {
              e.preventDefault(),
                v(e.currentTarget.firstChild).attr("disabled") ||
          ...
          if (((t = a[l]), Array.isArray(t))) f(e, t);
            ...
            m &&
              ((n = v("<li>", {
                id:
                  0 === u && "string" == typeof t ? d.sTableId + "_" + t : null,
              })
                .append(
                  v("<" + i + ">", {
                    href: r ? null : "#",
